...
public class CodeAttr extends Attribute implements AttrContainer {
    ...
    public final void fixupAdd(int kind, Label label) {
        fixupAdd(kind, this.f47PC, label);
    }
    ...
    public final void reserve(int bytes) {
        ...
        } else if (this.f47PC + bytes > this.code.length) {
            byte[] new_code = new byte[((this.code.length * 2) + bytes)];
            System.arraycopy(this.code, 0, new_code, 0, this.f47PC);
            this.code = new_code;
        }
    }
    ...
    public final void pushType(Type type) {
        ...
        } else if (this.f48SP + 1 >= this.stack_types.length) {
            Type[] new_array = new Type[(this.stack_types.length * 2)];
            System.arraycopy(this.stack_types, 0, new_array, 0, this.f48SP);
        ...
        this.f48SP = i2 + 1;
        typeArr2[i2] = type;
        if (this.f48SP > this.max_stack) {
            this.max_stack = this.f48SP;
        }
    }
    ...
    public final Type topType() {
        return this.stack_types[this.f48SP - 1];
    }
    ...
    public final void emitIfCompare1(int opcode) {
        ...
        new_if.start_stack_size = this.f48SP;
    }
    ...
    public final void emitThen() {
        this.if_stack.start_stack_size = this.f48SP;
    }
    ...
    public final void emitElse() {
        ...
        if (reachableHere()) {
            ...
            int growth = this.f48SP - this.if_stack.start_stack_size;
        ...
        while (this.f48SP > this.if_stack.start_stack_size) {
            popType();
        }
        this.f48SP = this.if_stack.start_stack_size;
        if (else_label != null) {
    ...
    public final void emitFi() {
        ...
        if (!this.if_stack.doing_else) {
            if (reachableHere() && this.f48SP != this.if_stack.start_stack_size) {
                throw new Error("at PC " + this.f47PC + " then clause grows stack with no else clause");
            }
            ...
            if (!reachableHere()) {
                ...
                this.f48SP = then_clause_stack_size;
            } else if (this.f48SP != then_clause_stack_size) {
                throw new Error("at PC " + this.f47PC + ": SP at end of 'then' was " + then_clause_stack_size + " while SP at end of 'else' was " + this.f48SP);
            }
    ...
    public void emitWithCleanupCatch(Variable catchVar) {
        ...
        emitTryEnd();
        if (this.f48SP > 0) {
            savedTypes = new Type[this.f48SP];
            System.arraycopy(this.stack_types, 0, savedTypes, 0, this.f48SP);
            this.f48SP = 0;
        } else {
            savedTypes = null;
        }
    ...
    public void emitWithCleanupDone() {
        ...
        emitTryCatchEnd();
        if (savedTypes != null) {
            this.f48SP = savedTypes.length;
            if (this.f48SP >= this.stack_types.length) {
                this.stack_types = savedTypes;
            } else {
                System.arraycopy(savedTypes, 0, this.stack_types, 0, this.f48SP);
            }
        } else {
            this.f48SP = 0;
        }
    ...
    public void emitTryStart(boolean has_finally, Type result_type) {
        ...
        if (result_type != null || this.f48SP > 0) {
            pushScope();
        }
        if (this.f48SP > 0) {
            savedStack = new Variable[this.f48SP];
            int i = 0;
            while (this.f48SP > 0) {
    ...
    public void write(DataOutputStream dstr) throws IOException {
        ...
        dstr.writeInt(this.f47PC);
        dstr.write(this.code, 0, this.f47PC);
