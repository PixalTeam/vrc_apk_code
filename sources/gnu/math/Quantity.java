...
public abstract class Quantity extends Numeric {
    ...
    /* renamed from: re */
    public RealNum mo11292re() {
        return number().mo11292re();
    }

    /* renamed from: im */
    public RealNum mo11291im() {
        return number().mo11291im();
    }
    ...
    public double doubleValue() {
        return unit().doubleValue() * mo11292re().doubleValue();
    }

    public double doubleImagValue() {
        return unit().doubleValue() * mo11291im().doubleValue();
    }
