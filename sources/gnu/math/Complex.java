...
public abstract class Complex extends Quantity {
    ...
    public boolean isExact() {
        return mo11292re().isExact() && mo11291im().isExact();
    }

    /* Debug info: failed to restart local var, previous not found, register: 4 */
    public Complex toExact() {
        RealNum re = mo11292re();
        RealNum im = mo11291im();
    ...
    public Complex toInexact() {
        return isExact() ? this : new DComplex(mo11292re().doubleValue(), mo11291im().doubleValue());
    }
    ...
    public double doubleValue() {
        return mo11292re().doubleValue();
    }

    public double doubleImagValue() {
        return mo11291im().doubleValue();
    }
    ...
    public static boolean equals(Complex x, Complex y) {
        return x.mo11292re().equals(y.mo11292re()) && x.mo11291im().equals(x.mo11291im());
    }
    ...
    public static int compare(Complex x, Complex y) {
        int code = x.mo11291im().compare(y.mo11291im());
        return code != 0 ? code : x.mo11292re().compare(y.mo11292re());
    }
    ...
    public boolean isZero() {
        return mo11292re().isZero() && mo11291im().isZero();
    }

    public String toString(int radix) {
        if (mo11291im().isZero()) {
            return mo11292re().toString(radix);
        }
        String imString = mo11291im().toString(radix) + "i";
        if (imString.charAt(0) != '-') {
            imString = "+" + imString;
        }
        return !mo11292re().isZero() ? mo11292re().toString(radix) + imString : imString;
    }

    public static Complex neg(Complex x) {
        return make(x.mo11292re().rneg(), x.mo11291im().rneg());
    }
    ...
    public static Complex add(Complex x, Complex y, int k) {
        return make(RealNum.add(x.mo11292re(), y.mo11292re(), k), RealNum.add(x.mo11291im(), y.mo11291im(), k));
    }
    ...
    public static Complex times(Complex x, Complex y) {
        RealNum x_re = x.mo11292re();
        RealNum x_im = x.mo11291im();
        RealNum y_re = y.mo11292re();
        RealNum y_im = y.mo11291im();
