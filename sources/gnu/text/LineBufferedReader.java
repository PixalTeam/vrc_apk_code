...
public class LineBufferedReader extends Reader {
    ...
    public LineBufferedReader(InputStream in) {
        this.f239in = new InputStreamReader(in);
    }
    ...
    public int fill(int len) throws IOException {
        return this.f239in.read(this.buffer, this.pos, len);
    }
    ...
    /* JADX WARNING: type inference failed for: r0v9, types: [char, int] */
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=char, code=null, for r0v9, types: [char, int] */
    ...
    public boolean ready() throws IOException {
        return this.pos < this.limit || this.f239in.ready();
    }
