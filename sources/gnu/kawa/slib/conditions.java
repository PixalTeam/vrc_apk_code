...
public class conditions extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public boolean lambda2(Object entry) {
            Object apply1 = C0605lists.car.apply1(entry);
            try {
    ...
    public static Mntype makeConditionType(Symbol name, Mntype supertype, Object fields) {
        if (!C0605lists.isNull(srfi1.lsetIntersection$V(Scheme.isEq, supertype.all$Mnfields, new Object[]{fields}))) {
    ...
    static Object conditionTypeFieldSupertype(Mntype condition$Mntype, Object field) {
        while (condition$Mntype != Boolean.FALSE) {
            if (C0605lists.memq(field, condition$Mntype.fields) != Boolean.FALSE) {
    ...
    public static condition makeCondition$V(Mntype type, Object[] argsArray) {
        ...
        return new condition(LList.list1(C0605lists.cons(type, alist)));
    }
    ...
    public static Object lambda1label(Object plist) {
        if (C0605lists.isNull(plist)) {
            return LList.Empty;
        }
        return C0605lists.cons(C0605lists.cons(C0605lists.car.apply1(plist), C0605lists.cadr.apply1(plist)), lambda1label(C0605lists.cddr.apply1(plist)));
    }

    public static boolean isConditionHasType(Object condition2, Mntype type) {
        Object types = conditionTypes(condition2);
        while (true) {
            Object apply1 = C0605lists.car.apply1(types);
            try {
                boolean x = isConditionSubtype((Mntype) apply1, type);
                if (x) {
                    return x;
                }
                types = C0605lists.cdr.apply1(types);
            } catch (ClassCastException e) {
                throw new WrongType(e, "condition-subtype?", 0, apply1);
            }
        }
    ...
    static Object typeFieldAlistRef(Object type$Mnfield$Mnalist, Object field) {
        while (!C0605lists.isNull(type$Mnfield$Mnalist)) {
            Object temp = C0605lists.assq(field, C0605lists.cdr.apply1(C0605lists.car.apply1(type$Mnfield$Mnalist)));
            if (temp != Boolean.FALSE) {
                return C0605lists.cdr.apply1(temp);
            }
            type$Mnfield$Mnalist = C0605lists.cdr.apply1(type$Mnfield$Mnalist);
        }
    ...
    public static condition makeCompoundCondition$V(Object condition$Mn1, Object[] argsArray) {
        ...
        Object cons = C0605lists.cons(condition$Mn1, conditions);
        Object obj = LList.Empty;
    ...
    public static condition extractCondition(condition condition2, Mntype type) {
        ...
        while (arg0 != LList.Empty) {
            try {
                Pair arg02 = (Pair) arg0;
                Object arg03 = arg02.getCdr();
                obj = Pair.make(C0605lists.assq(arg02.getCar(), C0605lists.cdr.apply1(entry)), obj);
                arg0 = arg03;
            } catch (ClassCastException e) {
                throw new WrongType(e, "arg0", -2, arg0);
            }
        }
        return new condition(LList.list1(C0605lists.cons(mntype, LList.reverseInPlace(obj))));
    }
    ...
    public static condition typeFieldAlist$To$Condition(Object type$Mnfield$Mnalist) {
        ...
        while (arg0 != LList.Empty) {
            try {
                ...
                Object apply1 = C0605lists.car.apply1(entry);
                Object arg04 = ((Mntype) C0605lists.car.apply1(entry)).all$Mnfields;
                Object obj = LList.Empty;
                while (arg04 != LList.Empty) {
                    try {
                        ...
                        Object x = C0605lists.assq(field, C0605lists.cdr.apply1(entry));
                        if (x == Boolean.FALSE) {
                            x = C0605lists.cons(field, typeFieldAlistRef(type$Mnfield$Mnalist, field));
                        }
                        obj = Pair.make(x, obj);
                        arg04 = arg06;
                    } catch (ClassCastException e) {
                ...
                lList = Pair.make(C0605lists.cons(apply1, LList.reverseInPlace(obj)), lList);
                arg0 = arg03;
            } catch (ClassCastException e2) {
    ...
    static Object checkConditionTypeFieldAlist(Object the$Mntype$Mnfield$Mnalist) {
        ...
        while (!C0605lists.isNull(type$Mnfield$Mnalist)) {
            Object entry = C0605lists.car.apply1(type$Mnfield$Mnalist);
            Object apply1 = C0605lists.car.apply1(entry);
            try {
                Mntype type = (Mntype) apply1;
                Object field$Mnalist = C0605lists.cdr.apply1(entry);
                Object obj = LList.Empty;
                ...
                while (arg04 != LList.Empty) {
                    try {
                        ...
                        while (true) {
                            Object apply12 = C0605lists.car.apply1(C0605lists.car.apply1(alist));
                            try {
                                try {
                                    ...
                                    alist = C0605lists.cdr.apply1(alist);
                                } catch (ClassCastException e2) {
