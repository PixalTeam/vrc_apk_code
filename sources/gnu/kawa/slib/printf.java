...
public class printf extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda2sign(Object i, Object cont) {
            if (Scheme.numLss.apply2(i, Integer.valueOf(this.f104n)) == Boolean.FALSE) {
                return Values.empty;
            }
            Object obj = this.str;
            try {
        ...
        public Object lambda3digits(Object i, Object cont) {
            ...
            Object j = i;
            while (true) {
                Object apply2 = Scheme.numGEq.apply2(j, Integer.valueOf(this.f104n));
                try {
        ...
        public Object lambda5(Object i, Object sgn, Object digs, Object ex) {
            ...
            frame0.digs = digs;
            frame0.f105ex = ex;
            if (Scheme.numEqu.apply2(i, Integer.valueOf(this.f104n)) != Boolean.FALSE) {
                return Scheme.applyToArgs.apply4(this.proc, frame0.sgn, frame0.digs, frame0.f105ex);
            }
            Object obj = this.str;
            try {
                try {
                    if (C0605lists.memv(Char.make(strings.stringRef((CharSequence) obj, ((Number) i).intValue())), printf.Lit2) != Boolean.FALSE) {
    ...
    public class frame1 extends ModuleBody {
        ...
        public Object lambda8(Object im$Mnsgn, Object im$Mndigs, Object im$Mnex) {
            return Scheme.applyToArgs.applyN(new Object[]{this.staticLink.staticLink.proc, this.sgn, this.digs, this.f106ex, im$Mnsgn, im$Mndigs, im$Mnex});
        }
    ...
    public class frame10 extends ModuleBody {
        ...
        public Object lambda22readFormatNumber() {
            Object[] objArr;
            if (Scheme.isEqv.apply2(printf.Lit66, this.staticLink.f111fc) != Boolean.FALSE) {
                this.staticLink.lambda18mustAdvance();
                Object ans = C0605lists.car.apply1(this.args);
                this.args = C0605lists.cdr.apply1(this.args);
                return ans;
            }
            Object c = this.staticLink.f111fc;
            Object obj = printf.Lit1;
            while (true) {
                Object obj2 = this.staticLink.f111fc;
                try {
                    if (!unicode.isCharNumeric((Char) obj2)) {
                        return obj;
                    }
                    this.staticLink.lambda18mustAdvance();
                    Object c2 = this.staticLink.f111fc;
        ...
        public Object lambda23pad$V(Object pre, Object[] argsArray) {
            ...
            try {
                ...
                while (Scheme.numGEq.apply2(valueOf, this.width) == Boolean.FALSE) {
                    if (!C0605lists.isNull(obj)) {
                        AddOp addOp = AddOp.$Pl;
                        Object apply1 = C0605lists.car.apply1(obj);
                        try {
                            valueOf = addOp.apply2(valueOf, Integer.valueOf(strings.stringLength((CharSequence) apply1)));
                            obj = C0605lists.cdr.apply1(obj);
                        } catch (ClassCastException e) {
                        ...
                        try {
                            ...
                            return C0605lists.cons(pre, append.append$V(objArr));
                        } catch (ClassCastException e2) {
                        ...
                        try {
                            return C0605lists.cons(pre, C0605lists.cons(strings.makeString(((Number) apply22).intValue(), printf.Lit9), makeList));
                        } catch (ClassCastException e3) {
                        ...
                        try {
                            return C0605lists.cons(strings.makeString(((Number) apply23).intValue(), printf.Lit29), C0605lists.cons(pre, makeList));
                        } catch (ClassCastException e4) {
                            throw new WrongType(e4, "make-string", 1, apply23);
                        }
                    }
                }
                return C0605lists.cons(pre, makeList);
            } catch (ClassCastException e5) {
            ...
            try {
                ...
                if (misc.isSymbol(obj)) {
                    ...
                    try {
                        ...
                        s2 = (!x2 ? C0605lists.isNull(obj) : x2) ? "0" : strings.isString(obj) ? obj : "1";
                    } catch (ClassCastException e5) {
        ...
        public Object lambda25(Object s) {
            try {
                this.f108pr = AddOp.$Pl.apply2(this.f108pr, Integer.valueOf(strings.stringLength((CharSequence) s)));
        ...
        public boolean lambda26(Object s) {
            ...
            try {
                Object sl = AddOp.$Mn.apply2(this.f108pr, Integer.valueOf(strings.stringLength((CharSequence) s)));
                try {
        ...
        public Boolean lambda27(Object s) {
            try {
                this.f108pr = AddOp.$Mn.apply2(this.f108pr, Integer.valueOf(strings.stringLength((CharSequence) s)));
                if (this.f107os == Boolean.FALSE) {
                    Scheme.applyToArgs.apply2(this.staticLink.out, s);
                } else {
                    Object obj = this.f108pr;
                    try {
                        if (numbers.isNegative(LangObjType.coerceRealNum(obj))) {
                            Scheme.applyToArgs.apply2(this.staticLink.out, this.f107os);
                            this.f107os = Boolean.FALSE;
                            Scheme.applyToArgs.apply2(this.staticLink.out, s);
                        } else {
                            this.f107os = strings.stringAppend(this.f107os, s);
                        }
                    } catch (ClassCastException e) {
    ...
    public class frame11 extends ModuleBody {
                                    ...
                                    try {
                                        try {
                                            try {
                                                ...
                                                return C0605lists.cons(idigs, (!x2 ? x2 : this.staticLink.alternate$Mnform == Boolean.FALSE) ? LList.Empty : LList.list2(".", fdigs));
                                            } catch (ClassCastException e2) {
        ...
        public Object lambda30formatReal$V(Object signed$Qu, Object sgn, Object digs, Object exp, Object[] argsArray) {
            ...
            if (C0605lists.isNull(rest)) {
                try {
                    String str2 = characters.isChar$Eq(printf.Lit5, (Char) sgn) ? "-" : signed$Qu != Boolean.FALSE ? "+" : this.staticLink.blank != Boolean.FALSE ? " " : "";
                    Object x = Scheme.isEqv.apply2(this.f109fc, printf.Lit13);
                    if (x == Boolean.FALSE ? Scheme.isEqv.apply2(this.f109fc, printf.Lit54) != Boolean.FALSE : x != Boolean.FALSE) {
                        obj = Boolean.FALSE;
                    } else {
                        Object x2 = Scheme.isEqv.apply2(this.f109fc, printf.Lit25);
                        if (x2 == Boolean.FALSE ? Scheme.isEqv.apply2(this.f109fc, printf.Lit26) != Boolean.FALSE : x2 != Boolean.FALSE) {
                            obj2 = lambda29f(digs, exp, Boolean.FALSE);
                            return C0605lists.cons(str2, obj2);
                        }
                        Object x3 = Scheme.isEqv.apply2(this.f109fc, printf.Lit55);
                        if (x3 == Boolean.FALSE ? Scheme.isEqv.apply2(this.f109fc, printf.Lit56) == Boolean.FALSE : x3 == Boolean.FALSE) {
                            if (Scheme.isEqv.apply2(this.f109fc, printf.Lit57) != Boolean.FALSE) {
                                str = "";
                            } else if (Scheme.isEqv.apply2(this.f109fc, printf.Lit58) != Boolean.FALSE) {
                                str = " ";
                            } else {
                                obj2 = Values.empty;
                                return C0605lists.cons(str2, obj2);
                        ...
                        if (Scheme.numGEq.apply2(AddOp.$Mn.apply2(this.end, this.cnt), Integer.valueOf(strings.stringLength((CharSequence) x))) == Boolean.FALSE) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    objArr[1] = x;
                                    this.f110s = strings.stringAppend(objArr);
                ...
                if (x2 == Boolean.FALSE) {
                    ...
                    try {
                        ...
                        if (!x3 ? x3 : Scheme.numGEq.apply2(this.cnt, this.end) != Boolean.FALSE) {
                            this.f110s = strings.stringAppend(this.f110s, strings.makeString(100));
                            Object obj8 = this.f110s;
                            try {
    ...
    public class frame4 extends ModuleBody {
        ...
        public Object lambda13(Object i, Object fdigs) {
            ...
            if (Scheme.numGEq.apply2(i, Integer.valueOf(this.staticLink.staticLink.staticLink.f104n)) != Boolean.FALSE) {
                return Scheme.applyToArgs.apply3(frame6.cont, i, printf.Lit1);
            }
            Object obj = this.staticLink.staticLink.staticLink.str;
            try {
                try {
                    if (C0605lists.memv(Char.make(strings.stringRef((CharSequence) obj, ((Number) i).intValue())), printf.Lit10) != Boolean.FALSE) {
    ...
    public class frame9 extends ModuleBody {
        ...
        public Object lambda18mustAdvance() {
            ...
            if (Scheme.numGEq.apply2(this.pos, Integer.valueOf(this.f112fl)) != Boolean.FALSE) {
            ...
            try {
                ...
                try {
                    this.f111fc = Char.make(strings.stringRef(charSequence, ((Number) obj2).intValue()));
                    return Values.empty;
                } catch (ClassCastException e) {
        ...
        public boolean lambda19isEndOfFormat() {
            return ((Boolean) Scheme.numGEq.apply2(this.pos, Integer.valueOf(this.f112fl))).booleanValue();
        }
        ...
        public Object lambda21out$St(Object strs) {
            ...
            while (true) {
                boolean x = C0605lists.isNull(strs);
                if (x) {
                    return x ? Boolean.TRUE : Boolean.FALSE;
                }
                Object x2 = Scheme.applyToArgs.apply2(this.out, C0605lists.car.apply1(strs));
                if (x2 == Boolean.FALSE) {
                    return x2;
                }
                strs = C0605lists.cdr.apply1(strs);
            }
        }
    }
    ...
    public static Object stdio$ClParseFloat(Object str, Object proc) {
        ...
        try {
            frame14.f104n = strings.stringLength((CharSequence) obj);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:239:0x04fb, code lost:
        if (kawa.standard.Scheme.numGrt.apply2(r12.width, gnu.kawa.functions.AddOp.$Mn.apply2(r12.precision, r12.f108pr)) == java.lang.Boolean.FALSE) goto L_0x03d8;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:240:0x04fd, code lost:
        r11 = kawa.standard.Scheme.applyToArgs;
        r13 = r2.out;
        r10 = gnu.kawa.functions.AddOp.$Mn.apply2(r12.width, gnu.kawa.functions.AddOp.$Mn.apply2(r12.precision, r12.f108pr));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:256:0x054d, code lost:
        kawa.standard.Scheme.applyToArgs.apply2(r2.out, r12.f107os);
     */
    ...
    public static java.lang.Object stdio$ClIprintf$V(java.lang.Object r17, java.lang.Object r18, java.lang.Object[] r19) {
        ...
        L_0x0092:
            ...
            java.lang.Object r11 = r2.f111fc
            java.lang.Object r9 = r9.apply2(r10, r11)
            java.lang.Boolean r10 = java.lang.Boolean.FALSE
            if (r9 == r10) goto L_0x013e
            r2.lambda18mustAdvance()
            java.lang.Object r6 = r2.f111fc
            gnu.kawa.functions.IsEqv r9 = kawa.standard.Scheme.isEqv
        ...
        L_0x022b:
            ...
            boolean r9 = kawa.lib.C0605lists.isNull(r9)
            if (r9 == 0) goto L_0x0264
            java.lang.Object r9 = r2.f111fc
            ...
            java.lang.Object r9 = kawa.lib.C0605lists.memv(r9, r10)
            java.lang.Boolean r10 = java.lang.Boolean.FALSE
            ...
            int r13 = kawa.lib.C0605lists.length(r13)
        ...
        L_0x037c:
            ...
            java.lang.Object r10 = r12.f108pr
        ...
        L_0x03ab:
            gnu.kawa.functions.NumberCompare r9 = kawa.standard.Scheme.numGrt
            java.lang.Object r10 = r12.width
            java.lang.Object r11 = r12.f108pr
            java.lang.Object r9 = r9.apply2(r10, r11)
            java.lang.Boolean r10 = java.lang.Boolean.FALSE
            ...
            gnu.kawa.functions.AddOp r9 = gnu.kawa.functions.AddOp.$Mn
            java.lang.Object r10 = r12.width
            java.lang.Object r14 = r12.f108pr
        ...
        L_0x04e1:
            ...
            java.lang.Object r0 = r12.f108pr
            r16 = r0
            ...
            goto L_0x03d8
        L_0x0528:
            java.lang.Object r9 = r12.f107os
        ...
        L_0x052f:
            ...
            gnu.kawa.functions.ApplyToArgs r9 = kawa.standard.Scheme.applyToArgs
            java.lang.Object r10 = r2.out
            java.lang.Object r11 = r12.f107os
            r9.apply2(r10, r11)
            goto L_0x03d8
        L_0x0558:
            r9 = 0
        ...
        L_0x07d1:
            ...
            java.lang.Object r9 = r10.f109fc
    ...
    public static Object sprintf$V(Object str, Object format, Object[] argsArray) {
        ...
        frame132.f110s = error$V;
        Object obj2 = frame132.f110s;
        try {
            ...
            if (Scheme.isEqv.apply2(frame132.end, frame132.cnt) != Boolean.FALSE) {
                return frame132.f110s;
            }
            Object obj3 = frame132.f110s;
            try {
