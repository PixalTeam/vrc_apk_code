                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status status : C04926.this.replies) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (User user : C04947.this.friends) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (DirectMessage message : C04968.this.messages) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status message : C048212.this.messages) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status tweet : C048413.this.tweets) {
