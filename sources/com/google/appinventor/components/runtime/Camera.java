    ...
    public void TakePicture() {
        ...
        if (!this.havePermission) {
            this.form.runOnUiThread(new Runnable() {
                public void run() {
                    Camera.this.form.askPermission("android.permission.CAMERA", new PermissionResultHandler() {
                        public void HandlePermissionResponse(String permission, boolean granted) {
                            ...
                            Camera.this.form.dispatchPermissionDeniedEvent((Component) this, "TakePicture", "android.permission.CAMERA");
                        }
                    });
                }
            });
