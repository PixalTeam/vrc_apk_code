...
public class srfi95 extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda1loop(Object x, Object kx, Object a, Object y, Object ky, Object b) {
            if (Scheme.applyToArgs.apply3(this.less$Qu, ky, kx) != Boolean.FALSE) {
                if (C0605lists.isNull(b)) {
                    return C0605lists.cons(y, C0605lists.cons(x, a));
                }
                return C0605lists.cons(y, lambda1loop(x, kx, a, C0605lists.car.apply1(b), Scheme.applyToArgs.apply2(this.key, C0605lists.car.apply1(b)), C0605lists.cdr.apply1(b)));
            } else if (C0605lists.isNull(a)) {
                return C0605lists.cons(x, C0605lists.cons(y, b));
            } else {
                return C0605lists.cons(x, lambda1loop(C0605lists.car.apply1(a), Scheme.applyToArgs.apply2(this.key, C0605lists.car.apply1(a)), C0605lists.cdr.apply1(a), y, ky, b));
            }
        }
    }
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda2step(Object n) {
            if (Scheme.numGrt.apply2(n, srfi95.Lit1) != Boolean.FALSE) {
                ...
                Object x = C0605lists.car.apply1(this.seq);
                Object y = C0605lists.cadr.apply1(this.seq);
                Object p = this.seq;
                this.seq = C0605lists.cddr.apply1(this.seq);
                if (Scheme.applyToArgs.apply3(this.less$Qu, Scheme.applyToArgs.apply2(this.keyer, y), Scheme.applyToArgs.apply2(this.keyer, x)) != Boolean.FALSE) {
                    try {
                        C0605lists.setCar$Ex((Pair) p, y);
                        Object apply1 = C0605lists.cdr.apply1(p);
                        try {
                            C0605lists.setCar$Ex((Pair) apply1, x);
                ...
                Object apply12 = C0605lists.cdr.apply1(p);
                try {
                    C0605lists.setCdr$Ex((Pair) apply12, LList.Empty);
                    return p;
                ...
                Object p2 = this.seq;
                this.seq = C0605lists.cdr.apply1(this.seq);
                try {
                    C0605lists.setCdr$Ex((Pair) p2, LList.Empty);
                    return p2;
    ...
    public class frame1 extends ModuleBody {
        ...
        public Object lambda3loop(Object r, Object a, Object kcara, Object b, Object kcarb) {
            if (Scheme.applyToArgs.apply3(this.less$Qu, kcarb, kcara) != Boolean.FALSE) {
                try {
                    C0605lists.setCdr$Ex((Pair) r, b);
                    if (C0605lists.isNull(C0605lists.cdr.apply1(b))) {
                        try {
                            C0605lists.setCdr$Ex((Pair) b, a);
                            return Values.empty;
                        } catch (ClassCastException e) {
                            throw new WrongType(e, "set-cdr!", 1, b);
                        }
                    } else {
                        return lambda3loop(b, a, kcara, C0605lists.cdr.apply1(b), Scheme.applyToArgs.apply2(this.key, C0605lists.cadr.apply1(b)));
                    }
                } catch (ClassCastException e2) {
                ...
                try {
                    C0605lists.setCdr$Ex((Pair) r, a);
                    if (C0605lists.isNull(C0605lists.cdr.apply1(a))) {
                        try {
                            C0605lists.setCdr$Ex((Pair) a, b);
                            return Values.empty;
                        } catch (ClassCastException e3) {
                            throw new WrongType(e3, "set-cdr!", 1, a);
                        }
                    } else {
                        return lambda3loop(a, C0605lists.cdr.apply1(a), Scheme.applyToArgs.apply2(this.key, C0605lists.cadr.apply1(a)), b, kcarb);
                    }
                } catch (ClassCastException e4) {
    ...
    public static Object isSorted(Object seq, Object less$Qu, Object key) {
        ...
        } else if (C0605lists.isNull(C0605lists.cdr.apply1(seq))) {
            return Boolean.TRUE;
        } else {
            Object last = Scheme.applyToArgs.apply2(key, C0605lists.car.apply1(seq));
            Object apply1 = C0605lists.cdr.apply1(seq);
            while (true) {
                boolean x4 = C0605lists.isNull(apply1);
                if (x4) {
                    return x4 ? Boolean.TRUE : Boolean.FALSE;
                }
                Object nxt2 = Scheme.applyToArgs.apply2(key, C0605lists.car.apply1(apply1));
    ...
    public static Object merge(Object a, Object b, Object isLess, Object key) {
        ...
        frame2.key = key;
        if (C0605lists.isNull(a)) {
            return b;
        }
        if (C0605lists.isNull(b)) {
            return a;
        }
        return frame2.lambda1loop(C0605lists.car.apply1(a), Scheme.applyToArgs.apply2(frame2.key, C0605lists.car.apply1(a)), C0605lists.cdr.apply1(a), C0605lists.car.apply1(b), Scheme.applyToArgs.apply2(frame2.key, C0605lists.car.apply1(b)), C0605lists.cdr.apply1(b));
    }
    ...
    static Object sort$ClMerge$Ex(Object a, Object b, Object isLess, Object key) {
        ...
        Object kcara = Scheme.applyToArgs.apply2(frame12.key, C0605lists.car.apply1(a));
        Object kcarb = Scheme.applyToArgs.apply2(frame12.key, C0605lists.car.apply1(b));
        if (Scheme.applyToArgs.apply3(frame12.less$Qu, kcarb, kcara) == Boolean.FALSE) {
            if (C0605lists.isNull(C0605lists.cdr.apply1(a))) {
                ...
                frame12.lambda3loop(a, C0605lists.cdr.apply1(a), Scheme.applyToArgs.apply2(frame12.key, C0605lists.cadr.apply1(a)), b, kcarb);
            }
            return a;
        } else if (C0605lists.isNull(C0605lists.cdr.apply1(b))) {
            try {
                C0605lists.setCdr$Ex((Pair) b, a);
                return b;
            } catch (ClassCastException e2) {
            ...
            frame12.lambda3loop(b, a, kcara, C0605lists.cdr.apply1(b), Scheme.applyToArgs.apply2(frame12.key, C0605lists.cadr.apply1(b)));
            return b;
        }
    }
    ...
    public static Object $PcSortList(Object seq, Object isLess, Object key) {
        ...
        if (key != Boolean.FALSE) {
            ...
            while (!C0605lists.isNull(lst)) {
                try {
                    C0605lists.setCar$Ex((Pair) lst, C0605lists.cons(Scheme.applyToArgs.apply2(key, C0605lists.car.apply1(lst)), C0605lists.car.apply1(lst)));
                    lst = C0605lists.cdr.apply1(lst);
                } catch (ClassCastException e) {
            ...
            try {
                frame02.seq = frame02.lambda2step(Integer.valueOf(C0605lists.length((LList) obj2)));
                Object lst2 = frame02.seq;
                while (!C0605lists.isNull(lst2)) {
                    try {
                        C0605lists.setCar$Ex((Pair) lst2, C0605lists.cdar.apply1(lst2));
                        lst2 = C0605lists.cdr.apply1(lst2);
                    } catch (ClassCastException e2) {
            ...
            try {
                return frame02.lambda2step(Integer.valueOf(C0605lists.length((LList) obj3)));
            } catch (ClassCastException e4) {
    ...
    public static Object sort$Ex(Sequence seq, Object less$Qu, Object key) {
        ...
        Object crt = ret;
        while (C0605lists.cdr.apply1(crt) != seq) {
            crt = C0605lists.cdr.apply1(crt);
        }
        try {
            C0605lists.setCdr$Ex((Pair) crt, ret);
            Object scar = C0605lists.car.apply1(seq);
            Object scdr = C0605lists.cdr.apply1(seq);
            try {
                C0605lists.setCar$Ex((Pair) seq, C0605lists.car.apply1(ret));
                try {
                    C0605lists.setCdr$Ex((Pair) seq, C0605lists.cdr.apply1(ret));
                    try {
                        C0605lists.setCar$Ex((Pair) ret, scar);
                        try {
                            C0605lists.setCdr$Ex((Pair) ret, scdr);
                            return seq;
                        } catch (ClassCastException e) {
    ...
    public static Object $PcVectorSort$Ex(Sequence seq, Object less$Qu, Object key) {
        ...
        Object obj = Lit3;
        while (!C0605lists.isNull(sorted)) {
            seq.set(((Number) obj).intValue(), C0605lists.car.apply1(sorted));
            sorted = C0605lists.cdr.apply1(sorted);
    ...
    public static void $PcSortVector(Sequence seq, Object less$Qu, Object key) {
        ...
        while (!C0605lists.isNull(sorted)) {
            try {
                vectors.vectorSet$Ex(newra, ((Number) obj).intValue(), C0605lists.car.apply1(sorted));
                sorted = C0605lists.cdr.apply1(sorted);
                obj = AddOp.$Pl.apply2(obj, Lit2);
            } catch (ClassCastException e) {
