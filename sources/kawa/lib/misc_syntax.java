...
public class misc_syntax extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda4f() {
            Object x = ports.read(this.f254p);
            if (!ports.isEofObject(x)) {
                return new Pair(std_syntax.datum$To$SyntaxObject(this.f253k, x), lambda4f());
            }
            ports.closeInputPort(this.f254p);
            return LList.Empty;
        }
    }
    ...
    static Object lambda1(Object form) {
        ...
        if (Lit1.match(form, allocVars, 0)) {
            ...
            try {
                ...
                return C0605lists.cons(execute, C0605lists.cons(std_syntax.datum$To$SyntaxObject(form, misc.string$To$Symbol(strings.stringAppend(objArr2))), Lit4.execute(allocVars, TemplateScope.make())));
    ...
    static Object lambda3(Object x) {
        ...
        frame2.f253k = execute;
        try {
            frame2.f254p = ports.openInputFile(Path.valueOf(fn));
