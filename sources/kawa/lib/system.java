...
public class system extends ModuleBody {
    ...
    public static final ModuleMethod f265catch;
    ...
    static {
        ...
        f265catch = new ModuleMethod(system2, 9, Lit10, 12291);
    ...
    public static Process makeProcess(Object args, Object env) {
        Object arargs = vectors.isVector(args) ? convertVectorToStringArray(args) : C0605lists.isList(args) ? convertListToStringArray(args) : strings.isString(args) ? command$Mnparse.apply1(args) : args instanceof String[] ? args : misc.error$V("invalid arguments to make-process", new Object[0]);
        try {
            try {
    ...
    public static Object convertListToStringArray(Object lst) {
        try {
            String[] arr = new String[C0605lists.length((LList) lst)];
            int i = 0;
            Object p = lst;
            while (!C0605lists.isNull(p)) {
                try {
                    Pair pp = (Pair) p;
    ...
    public static Object tokenizeStringToStringArray(String string) {
        ...
        while (toks.hasMoreTokens()) {
            rlist = C0605lists.cons(toks.nextToken(), rlist);
        }
        try {
            int count = C0605lists.length((LList) rlist);
            String[] arr = new String[count];
            int i = count - 1;
            Object p = rlist;
            while (!C0605lists.isNull(p)) {
    ...
    /* renamed from: catch reason: not valid java name */
    public static Object m54catch(Object key, Procedure thunk, Procedure handler) {
        try {
            return thunk.apply0();
    ...
    public Object apply3(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3) {
        ...
        try {
            try {
                return m54catch(obj, (Procedure) obj2, (Procedure) obj3);
            } catch (ClassCastException e) {
